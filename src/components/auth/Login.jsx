  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 title-font">登录账号</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-indigo-600 hover:text-indigo-500">
              注册新账号
                              ...
                              <p className="mt-2 text-center text-sm text-gray-300">            <span>或者 </span>            <Link to="/phone-login" className="font-medium text-indigo-600 hover:text-indigo-500">              使用手机验证码登录            </Link>          </p>
        </div>
